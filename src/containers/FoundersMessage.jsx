    ...
    return (
        <section className='container-border grid grid-cols-2 max-[990px]:grid-cols-1 gap-20 bg-pink !py-25 !px-20 max-sm:!py-13 max-sm:!px-4  h-full'>
            <div className="grid gap-8 max-w-[clamp(600px,100%,1000px)] max-md:order-2">
                <p className='text-center sm:text-start text-[18px] leading-[20px] font-bold'>FOUNDERS MSG</p>

                <SectionHeading text={'MISS YOUR CEREAL CHILDHOOD?'} className={"sm:text-start"} />

                <p className='text-center sm:text-start text-[18px] leading-[20px]'>
                ...
                <p className='text-center sm:text-start  text-[18px] leading-[20px] font-bold'>- ALEX, FOUNDER OF CRAVIES</p>
                <div>
                    <Button text='Build your bundle' className={'max-sm:!mx-auto'} />
                </div>
            </div>
